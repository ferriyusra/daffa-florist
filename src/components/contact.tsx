...
import { MessageCircle, Phone, MapPin, Clock, Send, CheckCircle, ArrowUpRight } from 'lucide-react';

const WHATSAPP_NUMBER = '6281234567890'; // Ganti dengan nomor WA asli Dafa Florist
				...
				>
					...
					<div className='space-y-5'>
								...
								<div className='absolute bottom-0 left-0 right-0 p-6 text-white'>
									<div className='flex items-center justify-between'>
										<div>
											...
											<h3 className='font-serif text-xl font-semibold'>Chat Langsung</h3>
											<p className='text-sm opacity-80 mt-1'>Respon cepat untuk konsultasi & pemesanan</p>
										</div>
						...
						>
							...
							<ArrowUpRight size={16} className='text-[var(--text-muted)] group-hover:text-[var(--primary)] transition-colors shrink-0' />
						</a>
					</div>
					...
					<div>
						...
						>
							<div>
								<h3 className='font-serif text-lg font-semibold mb-1'>Formulir Pemesanan</h3>
								<p className='text-xs' style={{ color: 'var(--text-muted)' }}>
							...
							<div className='grid sm:grid-cols-2 gap-4'>
								<div>
									<label htmlFor='name' className='block text-xs font-semibold uppercase tracking-wider mb-2' style={{ color: 'var(--text-secondary)' }}>
								...
								<div>
									<label htmlFor='phone' className='block text-xs font-semibold uppercase tracking-wider mb-2' style={{ color: 'var(--text-secondary)' }}>
							...
							<div>
								<label htmlFor='product' className='block text-xs font-semibold uppercase tracking-wider mb-2' style={{ color: 'var(--text-secondary)' }}>
								...
								>
									...
									<option value='Papan Bunga Duka Cita'>Papan Bunga Duka Cita</option>
									<option value='Bucket Bunga'>Bucket Bunga</option>
									<option value='Bunga Wisuda'>Bunga Wisuda</option>
									<option value='Dekorasi Mobil Pengantin'>Dekorasi Mobil Pengantin</option>
							...
							<p className='text-center text-[11px]' style={{ color: 'var(--text-muted)' }}>
								Formulir ini akan membuka chat WhatsApp dengan detail pesanan Anda
							</p>
						</form>
					</div>
				</motion.div>
