			...
			<div className='mx-auto max-w-[1200px] px-6'>
				...
				<div className='text-center max-w-[600px] mx-auto mb-12'>
					<span
						...
						style={{ background: 'rgba(139, 105, 20, 0.08)', color: 'var(--accent)' }}
					>
						Galeri
					</span>
					...
					<p className='text-lg leading-relaxed' style={{ color: 'var(--text-secondary)' }}>
						Koleksi rangkaian bunga yang telah kami buat untuk pelanggan di Ampar Putih dan sekitarnya.
					</p>
				</div>
						...
						>
							...
							>
								...
								<div className='p-6'>
									...
									<h3 className='font-serif text-xl font-semibold mt-1'>{filtered[lightbox].title}</h3>
								</div>
							</motion.div>
						</motion.div>
					)}
